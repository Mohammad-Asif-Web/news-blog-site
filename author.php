        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $sqlHead = "SELECT * FROM post JOIN user
                    ...
                    ?>
                  <h2 class="page-heading"><?php echo $rowHead['username']?></h2>
                  <?php
                        ...
                        // show pagination
                        $sqlPage = "SELECT * FROM user WHERE user_id = $auth_id";
                        ...
                        if(mysqli_num_rows($resultPage) > 0){
                            ...
                            $total_records = mysqli_num_rows($resultHead); 
                            $total_page = ceil($total_records / $limit);
    
                            echo "<ul class='pagination admin-pagination'>";
                            if($page > 1){
                                echo '<li><a href="author.php?auth_id='.$auth_id .'&page='.($page - 1).'">Prev</a></li>';
                            }
                            ...
                            if($total_page > $page){
                                echo '<li><a href="author.php?auth_id='.$auth_id.'&page='.($page + 1).'">Next</a></li>';
                            }
                            echo "</ul>";
                        }  
                        ?>
